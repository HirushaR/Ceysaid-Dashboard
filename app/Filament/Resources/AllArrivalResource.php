...
use App\Filament\Resources\AllArrivalResource\Pages;
use App\Models\Lead;
...
class AllArrivalResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListAllArrivals::route('/'),
            'view' => Pages\ViewAllArrival::route('/{record}'),
        ];
    }
