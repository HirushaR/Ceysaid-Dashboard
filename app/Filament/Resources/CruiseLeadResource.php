...
use App\Filament\Resources\CruiseLeadResource\Pages;
use Filament\Forms;
use Filament\Forms\Form;
use App\Enums\LeadStatus;
use App\Enums\Platform;

class CruiseLeadResource extends Resource
{
    protected static ?string $model = Lead::class;
    protected static ?string $navigationIcon = 'heroicon-o-globe-alt';
    protected static ?string $navigationLabel = 'Cruise Lead';
    protected static ?string $label = 'Cruise Lead';
    protected static ?string $pluralLabel = 'Cruise Leads';
    ...
    {
        return [
            'index' => Pages\ListCruiseLeads::route('/'),
            'view' => Pages\ViewCruiseLead::route('/{record}'),
        ];
    }
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('id')
                    ...
                    ->searchable()
                    ->copyable()
                    ->formatStateUsing(fn ($state) => "CL-{$state}")
