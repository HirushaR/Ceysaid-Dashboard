...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            // Quotes
            ['name' => 'quotes.view', 'display_name' => 'View Quotes', 'resource' => 'quotes', 'action' => 'view', 'description' => 'Can view quotes'],
            ['name' => 'quotes.create', 'display_name' => 'Create Quotes', 'resource' => 'quotes', 'action' => 'create', 'description' => 'Can create quotes'],
            ['name' => 'quotes.edit', 'display_name' => 'Edit Quotes', 'resource' => 'quotes', 'action' => 'edit', 'description' => 'Can edit quotes'],
            ['name' => 'quotes.delete', 'display_name' => 'Delete Quotes', 'resource' => 'quotes', 'action' => 'delete', 'description' => 'Can delete quotes'],

            // Suppliers (accounting master data)
            ['name' => 'suppliers.view', 'display_name' => 'View Suppliers', 'resource' => 'suppliers', 'action' => 'view', 'description' => 'Can view suppliers'],
